...
public class DBManager {
    ...
    public void insert(String ENGLISHTITTLE, String DUAINARABIC, String ENGLISHREF,
                       String ENGLISHTRANSLATE, String URDUTITTLE, String URDUTRANSLATE, String TYPE, Boolean Fav, String Audio,String Roman) {
    ...
    public Cursor fetch() {
        String[] columns = new String[]{DatabaseHelper._ID, DatabaseHelper.ENGLISHTITTLE, DatabaseHelper.DUAINARABIC, DatabaseHelper.ENGLISHREF
                , DatabaseHelper.ENGLISHTRANSLATE, DatabaseHelper.URDUTITTLE, DatabaseHelper.URDUTRANSLATE, DatabaseHelper.AUDIO, DatabaseHelper.FAV, DatabaseHelper.TYPE,DatabaseHelper.Roman};
